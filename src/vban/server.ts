...
namespace Server {
    ...
    export function on(event: "message", handler: (msg: string, sender: UserData) => void): void;
    ...
    export function emit(event: "message", msg: string, sender: UserData): void;
    export function emit(event: "userStatusChanged", user: UserData, status: UserStatus): void;
